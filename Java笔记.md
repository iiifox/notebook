...
> 说明：此时的容量大小指的是表示数的范围的大小。比如：float 容量要大于 long 的容量
...
- 对于添加成功的情况2和情况3而言：元素a与已经存在指定索引位置上数据以链表的方式存储。
  ...
  - 总结：七上八下
- HashSet底层：数组+链表(JDK 7及之前)或数组+链表+红黑树(JDK 8)
